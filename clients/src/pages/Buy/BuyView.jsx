          ...
          <div className={Styles.filters}>
            ...
            <div>
              ...
              {activeFilters.valoration > 0 && (
                <button className={Styles.sortTags}>Avg Customer Review</button>
              )}
              {activeFilters.price && (
                <button className={Styles.sortTags}>Price: Low to High</button>
              )}
              {activeFilters.price && (
                <button className={Styles.sortTags}>Price: High to Low</button>
              )}
              {activeFilters.category > 0 && (
                <button className={Styles.filtersTags}>Categories</button>
              )}
              {activeFilters.brand && (
                <button className={Styles.filtersTags}>Brands</button>
              )}
            </div>
          </div>
